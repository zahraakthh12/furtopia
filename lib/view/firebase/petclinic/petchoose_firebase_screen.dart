...
import 'package:furtopia/view/firebase/petclinic/petclinic_firebase_booking.dart';

class PetChooseFirebaseScreen extends StatefulWidget {
  const PetChooseFirebaseScreen({super.key});

  @override
  State<PetChooseFirebaseScreen> createState() => _PetChooseFirebaseScreenState();
}
                            ...
                            child: ElevatedButton(
                              onPressed: () {
                                Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                    builder: (context) => BookingFirebaseScreen(
                                    ),
                                  ),
                                );
                              },
