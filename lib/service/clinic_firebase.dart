...
class ClinicBookingService {
  ...
  // Tanggal hari ini (booking date belum dipilih, tapi invoice dibuat saat submit)
  final today = DateTime.now();
  final datePart = "${today.year}"
  ...
  // Cari booking yang sudah ada untuk tanggal dan kategori ini
  ...
  return "$datePart-$categoryCode-$numberPart";
}
